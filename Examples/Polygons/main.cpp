...
int main()
{
    ...
    Triangle2 t1 = Triangle2(Vector2(0,0), Vector2(1,1), Vector2(0,1));
    ...
    Rectangle2 r1 = Rectangle2(Vector2(0,0), Vector2(2,0), Vector2(0,1));
    ...
    Polygon2 p1 = Polygon2();
    p1.AddPoint(Vector2(0,0));
    p1.AddPoint(Vector2(1,1));
    p1.AddPoint(Vector2(2,3));
    p1.AddPoint(Vector2(0,2));
    ...
    Polygon2 p2 = Polygon2();
    p2.AddPoint(Vector2(0,0));
    p2.AddPoint(Vector2(2,2));
    p2.AddPoint(Vector2(0,2));
    p2.AddPoint(Vector2(2,0));
	//no need to add last point (0,0)
